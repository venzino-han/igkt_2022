...
class KT_Sequence_Graph(Dataset):
    def __init__(self, user_groups, item_groups, df, part_matrix, tag_coo_matrix, seq_len, knowledge_concept):
        self.user_seq_dict = {}
...
def get_dataloader_assist(batch_size, num_workers=8, seq_len=64, knowledge_concept=True):
